<template>
  <!--region tab导航切换页-->
  <div class="tag-bar" ref="tagsContainer">
    <div class="tag-container" ref="tagsList">
      <template v-for="(item, index) in tagbar.list">
        <div :class="tagActive(item) ? 'tag-item active' : 'tag-item'" @click.right="rightMenus($event, item)">
